...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = f'sqlite:///{DB_NAME}' # db path using flask sql
    ...
    from .models import User, Post, Comment, Like, SubscribeInfo # import all models before creating database
